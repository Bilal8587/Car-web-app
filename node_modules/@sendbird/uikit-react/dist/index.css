...
.sendbird-theme--light .sendbird-channel-settings .sendbird-channel-settings__panel-item:last-child {
  border-bottom: 1px solid var(--sendbird-light-onlight-04);
}
...
.sendbird-theme--dark .sendbird-channel-settings .sendbird-channel-settings__panel-item:last-child {
  border-bottom: 1px solid var(--sendbird-dark-ondark-04);
}
