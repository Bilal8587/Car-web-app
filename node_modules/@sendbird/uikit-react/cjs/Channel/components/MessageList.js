...
var types = require('../../chunks/bundle-NcNHnfKv.js');
var utils$1 = require('../../chunks/bundle-D6csOw30.js');
...
var consts = require('../../chunks/bundle-D_IGJ-UU.js');
var useSendbirdStateContext = require('../../useSendbirdStateContext.js');
var Message_context = require('../../Message/context.js');
var index = require('../../chunks/bundle-SEtzg2pM.js');
var useThrottleCallback = require('../../chunks/bundle-B2MmAE_J.js');
var ui_TypingIndicatorBubble = require('../../ui/TypingIndicatorBubble.js');
var index$1 = require('../../chunks/bundle-uQxUka-j.js');
var Channel_utils_getMessagePartsInfo = require('../utils/getMessagePartsInfo.js');
var utils = require('../../chunks/bundle-C9dUt1j_.js');
require('../../chunks/bundle-CXzY5rVA.js');
require('../../chunks/bundle-C5MmL5yU.js');
require('@sendbird/uikit-tools');
require('../../withSendbird.js');
require('../../chunks/bundle-D_aAITb2.js');
require('../../chunks/bundle-QL_tq1Vi.js');
require('@sendbird/chat/groupChannel');
require('../../utils/message/getOutgoingMessageState.js');
require('../../chunks/bundle-HekRAZ-p.js');
require('../../chunks/bundle-BekF9PeY.js');
require('react-dom');
require('../../chunks/bundle-BsZ9e1OW.js');
require('../../chunks/bundle-Cpuh_hmr.js');
require('../../chunks/bundle-DvvSnKiJ.js');
require('../../ui/IconButton.js');
require('../../ui/Button.js');
require('../../chunks/bundle-B0_1JTh1.js');
require('css-vars-ponyfill');
require('@sendbird/chat');
require('../../chunks/bundle-CCfEEGZT.js');
require('@sendbird/chat/openChannel');
require('../../chunks/bundle-D9TPG-dw.js');
require('../../chunks/bundle-C9UhSess.js');
require('../../ui/SortByRow.js');
require('../../chunks/bundle-Bc-DjgOv.js');
require('../../chunks/bundle-BEJP-RCX.js');
require('../../chunks/bundle-DWHg78Gy.js');
require('@sendbird/chat/message');
require('../../chunks/bundle-K-9BJXVz.js');
require('../../chunks/bundle-DxJ2jUl9.js');
require('../../chunks/bundle-DDLep1fi.js');
require('../../chunks/bundle-Bf-dAh88.js');
require('../../chunks/bundle-DAkNTCba.js');
require('../../chunks/bundle-C2B8Wwc4.js');
require('../../chunks/bundle-CpqLJPov.js');
require('../../chunks/bundle-Nk4N9epV.js');
require('../../chunks/bundle-DA96gYzD.js');
require('../../ui/Loader.js');
require('../../chunks/bundle-R4srl1Nb.js');
require('../../chunks/bundle-TwlKYkkB.js');
require('../../Message/hooks/useDirtyGetMentions.js');
require('../../ui/DateSeparator.js');
require('../../chunks/bundle-CAq16sKH.js');
require('../../ui/MessageInput.js');
require('../../chunks/bundle-DkexSD0g.js');
require('../../chunks/bundle-dRqURxfP.js');
require('dompurify');
require('../../chunks/bundle-v_4wu87G.js');
require('../../chunks/bundle-CfZq5vEi.js');
require('../../chunks/bundle-Cs90VeJL.js');
require('../../chunks/bundle-BKGMWgjB.js');
require('../../ui/MessageContent.js');
require('../../chunks/bundle-BlT-csJI.js');
require('../../chunks/bundle-Bl3MWz31.js');
require('../../chunks/bundle-CHG_eoB7.js');
require('../../chunks/bundle-Cx_AtXvu.js');
require('../../ui/MessageItemReactionMenu.js');
require('../../ui/ImageRenderer.js');
require('../../ui/ReactionButton.js');
require('../../chunks/bundle-DQTt3t1y.js');
require('../../ui/EmojiReactions.js');
require('../../ui/ReactionBadge.js');
require('../../ui/BottomSheet.js');
require('../../ui/UserListItem.js');
require('../../chunks/bundle-CpNphatI.js');
require('../../chunks/bundle-BrZukI3D.js');
...
require('../../chunks/bundle-Ce1AhZRK.js');
require('../../ui/MobileMenu.js');
require('../../ui/ThreadReplies.js');
require('../../chunks/bundle-BjL-fbex.js');
require('../../ui/OGMessageItemBody.js');
require('../../chunks/bundle-BkcVGDjn.js');
require('../../ui/MentionLabel.js');
require('../../ui/LinkLabel.js');
require('../../ui/TextMessageItemBody.js');
require('../../ui/FileMessageItemBody.js');
require('../../ui/TextButton.js');
require('../../chunks/bundle-D7lzZHvD.js');
require('../../ui/FileViewer.js');
require('../../chunks/bundle-D8lzfXkZ.js');
...
require('../../chunks/bundle-D4y5iRWL.js');
...
require('../../ui/Input.js');
require('../../chunks/bundle-CJMDrgfZ.js');
require('../../GroupChannel/components/SuggestedReplies.js');
require('../../chunks/bundle-D0xdvRCq.js');
require('./FileViewer.js');
require('../../chunks/bundle-Dp4e-XxD.js');
require('./RemoveMessageModal.js');
require('../../chunks/bundle-FZr6OOZI.js');
require('../../chunks/bundle-BzLL-qrn.js');
...
var MessageList = function (props) {
    ...
    var _g = utils.deleteNullish(props), renderMessage = _g.renderMessage, renderMessageContent = _g.renderMessageContent, renderSuggestedReplies = _g.renderSuggestedReplies, renderCustomSeparator = _g.renderCustomSeparator, _h = _g.renderPlaceholderLoader, renderPlaceholderLoader = _h === void 0 ? function () { return React__default.default.createElement(ui_PlaceHolder.default, { type: ui_PlaceHolder.PlaceHolderTypes.LOADING }); } : _h, _j = _g.renderPlaceholderEmpty, renderPlaceholderEmpty = _j === void 0 ? function () { return React__default.default.createElement(ui_PlaceHolder.default, { className: "sendbird-conversation__no-messages", type: ui_PlaceHolder.PlaceHolderTypes.NO_MESSAGES }); } : _j, _k = _g.renderFrozenNotification, renderFrozenNotification = _k === void 0 ? function () { return React__default.default.createElement(GroupChannel_components_FrozenNotification.FrozenNotification, { className: "sendbird-conversation__messages__notification" }); } : _k;
    ...
    return (React__default.default.createElement(React__default.default.Fragment, null,
        ...
        React__default.default.createElement("div", { className: "sendbird-conversation__messages ".concat(className) },
            React__default.default.createElement("div", { className: "sendbird-conversation__scroll-container" },
                ...
                React__default.default.createElement("div", { className: "sendbird-conversation__messages-padding", "data-testid": "sendbird-message-list-container", ref: scrollRef, onScroll: function (e) {
                    ...
                    !hasMoreNext
                        ...
                        && ((_e = (_d = (_c = store === null || store === void 0 ? void 0 : store.config) === null || _c === void 0 ? void 0 : _c.groupChannel) === null || _d === void 0 ? void 0 : _d.typingIndicatorTypes) === null || _e === void 0 ? void 0 : _e.has(types.TypingIndicatorType.Bubble)) && (React__default.default.createElement(ui_TypingIndicatorBubble, { typingMembers: typingMembers, handleScroll: moveScroll })))),
