...
var index$2 = require('../chunks/bundle-DWHg78Gy.js');
...
var index$1 = require('../chunks/bundle-QL_tq1Vi.js');
...
var _const = require('../chunks/bundle-Bc-DjgOv.js');
var index = require('../chunks/bundle-BjL-fbex.js');
...
function MessageContent(props) {
    ...
    var totalBottom = React.useMemo(function () { return getTotalBottom(); }, []);
    ...
    return (React__default.default.createElement("div", { className: index$1.getClassName([
        ...
        React__default.default.createElement("div", { className: utils.classnames('sendbird-message-content__left', isReactionEnabledClassName, isByMeClassName, useReplyingClassName), "data-testid": "sendbird-message-content__left" },
            renderSenderProfile(_tslib.__assign(_tslib.__assign({}, props), { className: 'sendbird-message-content__left__avatar', isByMe: isByMe, displayThreadReplies: displayThreadReplies, bottom: totalBottom > 0 ? totalBottom + 'px' : '' })),
