...
// node_modules/@sendbird/chat/lib/__bundle-4b40b3a8.js
var i = function(i2, u) {
  return new Promise(function(c, p) {
    if ("undefined" != typeof XMLHttpRequest) {
      var f = Ws.of(i2), l = f.dispatcher, g = f.logger, h = u.requestId, m = u.method, q = u.url, v2 = u.headers, b = void 0 === v2 ? {} : v2, w = u.data, E = void 0 === w ? "" : w, x = u.uploadProgressHandler, y = false, H = new XMLHttpRequest();
      H.open(m, q), Object.keys(b).forEach(function(e) {
        H.setRequestHeader(e, b[e]);
...
//# sourceMappingURL=__bundle-4b40b3a8-LNQGFSVP.js.map
